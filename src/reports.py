"""
Report generation utilities for model performance.
"""
import os
import json
...
def create_report_directories(model_name):
    """Create necessary directories for reports and models."""
...
def create_class_comparison_plot(per_class_metrics, dirs, model_name):
    """Create per-class metrics comparison bar chart."""
...
def ensure_macro_avg(per_class_metrics):
    """Ensure macro_avg is present in metrics."""
